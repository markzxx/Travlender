...
//    // PriorityQueue<CommomAlarmEvent> remindEvents;//查询队列,目前只有一个元素
//    AlarmEvent remindEvent;
//
//    @Override
//    public void onCreate() {
//        super.onCreate();
//        //remindEvents = new PriorityQueue<CommomAlarmEvent>(10, eventComparator);
...
////        remindEvent = new CommomAlarmEvent(event, intent.getLongExtra("onwayTime",0));
